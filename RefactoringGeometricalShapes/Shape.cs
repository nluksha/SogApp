...
namespace RefactoringGeometricalShapes
{
    public class Shape
    {
        ...
        /// </summary>
        /// <param name="type">the type of the shape (SQUARE/CIRCLE/EQUILATERAL_TRIANGLE)</param>
        ...
        /// <summary>
        /// This method generates a HTML string used to be displayed as a web page. The generated string depends on the language of the user.
        /// </summary>
